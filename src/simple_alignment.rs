...
use rust_vc_utils::cigar::{self, get_cigar_read_offset, get_cigar_ref_offset};
...
impl fmt::Debug for SimpleAlignment {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        let cigar_read_len = get_cigar_read_offset(&self.cigar, true);
        write!(
            f,
...
pub fn clip_alignment_ref_edges(
    ...
    let (clipped_cigar, clipped_ref_shift) = cigar::clip_alignment_ref_edges(
        &alignment.cigar,
