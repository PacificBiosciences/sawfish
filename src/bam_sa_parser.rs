...
pub struct FwdStrandSplitReadSegment {
    ...
    /// Sequencer-order read position of right-most position of the alignment segment
...
pub fn get_fwd_read_split_segments(
    ...
    let primary_read_size = {
        ...
        fwd_read_split_segments.push(FwdStrandSplitReadSegment {
            fwd_read_start,
            fwd_read_end,
